...
> **This log covers `docs/specs/goal.md` (v1), which is complete.**
> The active goal is `docs/specs/goal2.md`. Its progress log lives in `docs/progress/v2.md` (v2 also complete as of 2026-05-12).
> Kept here for historical reference only.

## v1 milestones (shipped)

- Read `docs/specs/goal.md` and implemented a static Next.js App Router project with `output: "export"`.
